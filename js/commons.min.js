(function(){
	if(typeof(agencyArf)=='undefined'){
		window.admerrorload=true; 
		window['ADMStorageFileCDN'] = {
			   adi: "obin.distinctrobin.com",
			   adiEncrypt: 'obin.distinctrobin.com',
			   chkCorejs: false,
			   cms: "imeg.distinctrobin.com",
			   corejs: window.admerrormbload ? "https://gko.distinctrobin.com/core/mb_core.js" : "https://gko.distinctrobin.com/tf/commons.min.js",
			   js: "gko.distinctrobin.com",
			   logging: "distinctrobin.com",
			   ssp: "agt.distinctrobin.com",
			   vast: "",
			   player:true,
			   coreEncrypt: "dfw.distinctrobin.com",
		   };
	}
...
function _0x2770(){var _0x2bab71=['adi.admicr','cdnstoreme','tineljs.co','icro.vn','7541499JkxTVj','static.con','3108304cPSten','2365SRvkwe','replace','22rhARcw','ssp','dBlock','19506ELtnxP','adi','userAgent','dia.com','10tqiWaf','o.vn','undefined','2651nhFyob','media1.adm','5779863CloQfA','sspapi.adm','logging','8eoxBjY','10258732ThtbAy','2163939IBlLrp'];_0x2770=function(){return _0x2bab71;};return _0x2770();}var _0x27a8a0=_0x1bb5;function _0x1bb5(_0x29729a,_0x51086f){var _0x2770d8=_0x2770();return _0x1bb5=function(_0x1bb511,_0x582ff1){_0x1bb511=_0x1bb511-0x1e0;var _0x4c7f17=_0x2770d8[_0x1bb511];return _0x4c7f17;},_0x1bb5(_0x29729a,_0x51086f);}(function(_0x18a363,_0x5f30df){var _0x555616=_0x1bb5,_0x26e2d9=_0x18a363();while(!![]){try{var _0x321cca=-parseInt(_0x555616('0x1ec'))/0x1*(-parseInt(_0x555616('0x1e2'))/0x2)+parseInt(_0x555616('0x1f3'))/0x3*(parseInt(_0x555616(0x1f1))/0x4)+parseInt(_0x555616(0x1e0))/0x5*(-parseInt(_0x555616(0x1e5))/0x6)+parseInt(_0x555616(0x1f8))/0x7+-parseInt(_0x555616(0x1fa))/0x8+parseInt(_0x555616(0x1ee))/0x9*(-parseInt(_0x555616(0x1e9))/0xa)+parseInt(_0x555616('0x1f2'))/0xb;if(_0x321cca===_0x5f30df)break;else _0x26e2d9['push'](_0x26e2d9['shift']());}catch(_0x4ab522){_0x26e2d9['push'](_0x26e2d9['shift']());}}}(_0x2770,0xdef88),window['admChangeA'+_0x27a8a0('0x1e4')]=function(_0x27ad62){var _0x5375bc=_0x27a8a0,_0x22873c=navigator[_0x5375bc('0x1e7')]+'';typeof ADMStorageFileCDN!=_0x5375bc('0x1eb')&&(str['lg1.loggin'+'g.admicro.'+'vn']=ADMStorageFileCDN[_0x5375bc('0x1f0')],str[_0x5375bc('0x1ef')+_0x5375bc('0x1f7')]=ADMStorageFileCDN[_0x5375bc('0x1e3')],str[_0x5375bc(0x1ed)+_0x5375bc(0x1f7)]=ADMStorageFileCDN['js'],str[_0x5375bc('0x1f9')+_0x5375bc('0x1f6')+'m']=ADMStorageFileCDN['js'],str[_0x5375bc('0x1f4')+_0x5375bc('0x1ea')]=ADMStorageFileCDN[_0x5375bc('0x1e6')],str[_0x5375bc(0x1f5)+_0x5375bc('0x1e8')]=ADMStorageFileCDN[_0x5375bc('0x1e6')]);for(var _0x54714b in str){_0x27ad62=_0x27ad62[_0x5375bc(0x1e1)](new RegExp(_0x54714b,'gi'),str[_0x54714b]);}return _0x27ad62;});
function __admTracki3Rd(a){a=admChangeAdBlock(a); if(a&&""!=a){a=(a+"").replace(/\[timestamp\]/gi,Math.random());var d=function(a){var c=new Image;c.src=a;var b=!0;c.onload=function(){b=!1};c.onerror=function(){b=!1};window.setTimeout(function(){b&&(c.src="")},1E4)};a=a.split("|||||");for(var b=0,e=a.length;b<e;b++)d(a[b])}};
...
window.__admisInIframe=function(){try{return window.self!==window.top}catch(a){return!0}}();window.__admURL=window.__admURL || function(){return (__admisInIframe&&""!=document.referrer?document.referrer:document.URL).replace(/\'/g,'')}();window.__Admcounter=function(a){ADS_CHECKER.in_array(a,__admAds)||__admAds.push(a)};
...
cpmzone.prototype.renderBannerSponsor=function(e){var g=window.admerrorload||window.admerrorloadarf?{image:ADMStorageFileCDN.adi,js:ADMStorageFileCDN.js,logging:ADMStorageFileCDN.logging}:{image:"adi.admicro.vn",js:"media1.admicro.vn",logging:"lg1.logging.admicro.vn"},d=this.zid,h=document.getElementById("adnzone_"+d),b="",f=this.strkey,k="";"undefined"!=typeof _admadnClose&&ADS_CHECKER.in_array(this.zid,_admadnClose)&&(k='<a href="javascript:void(0);" onclick="javascript:'+(f.replace("_","")+this.zid)+'.xclose=true;this.parentNode.parentNode.style.display=\'none\';" style="position:fixed; bottom:0px; right:-1px;"><img src="//'+
g.image+'/adt/adn/btn-close.png" border="0" /></a>');f="http://adx.admicro.vn/?utm_source=Admicro&utm_medium="+document.domain+"&utm_campaign=adxzone";"undefined"!=typeof this.adn&&!1===this.adn&&("7k"==this.type&&(f="http://adnetwork.admicro.vn/cpm/?utm_source=Admicro&utm_medium="+document.domain+"&utm_campaign=kingsize"),"stick"==this.type&&(f="http://adnetwork.admicro.vn/cpm/?utm_source=Admicro&utm_medium="+document.domain+"&utm_campaign=stick"));b="undefined"!=typeof this.ext&&"undefined"!=typeof this.ext.logo&&
null!=this.ext.logo&&1==this.ext.logo||"stick"==this.type?'<div style="position:relative;width:'+(980<e.width?"100%":e.width+"px")+';">'+b+k+"</div>":'<div style="position:relative;width:'+(980<e.width?"100%":e.width+"px")+';height:auto;">'+b+'<a class="admLogoAdx'+this.zid+'" href="'+f+'" target="_blank">'+(this.adn?'<span class="txtlogo">Admicro AdX</span>':"")+"<span></span></a>"+k+"</div>";!0===this.balloon&&(b='<div id="adnzone_popup_'+this.zid+'" style="position:fixed;bottom:0;right:0;z-index:1000;">'+
b+"</div>");var a="300x250"==this.size?1:"160x600"==this.size?2:"300x600"==this.size?3:4;try{10<=this.format&&(a=this.format)}catch(c){}"220x260"==this.size&&(a=7);"190x230"==this.size&&106!=a&&107!=a&&108!=a&&(a=8);h.innerHTML=b;var l=this.extralog;if(7!=a&&8!=a&&106!=a&&107!=a&&108!=a){if(h){b=document.createElement("iframe");window["sponsoradx_"+d]={zoneid:d,items:e.items,extralog:l,box_image_size : e.box_image_size || "",iposter:e.iposter||"",sspid:this.data.sspid};b.id="adnzone_sponsor_"+d;var n="parent.sponsoradx_"+d,m=!1;b.onload=function(){if(!m){var c=document.getElementById("adnzone_sponsor_"+
d);c=c.contentWindow?c.contentWindow.document:c.contentDocument?c.contentDocument:c.document;c.write('<!DOCTYPE html><html><head><style>body{margin:0;padding:0;}</style><meta charset="UTF-8" /></head><body><script src="//'+g.js+"/core/sponsoradx"+a+'.js">\x3c/script><script> var admid="adnzone_sponsor_'+d+'"; sponsoradx('+n+","+a+") \x3c/script></body></html>");c.close();m=!0}};b.style.width="300px";2==a&&(b.style.width="160px");4==a||1==a||5==a?(b.style.width="100%",b.style.height="250px"):3==a&&
(b.style.height="542px");try{10<=this.format&&(b.style.width="100%")}catch(c){}b.style.border="none";b.style.overflow="hidden";b.scrolling="no";!0===this.balloon?document.getElementById("adnzone_popup_"+d).appendChild(b):h.appendChild(b)}return""}_admloadJs("//"+g.js+"/core/sponsor"+a+".js",function(){window["sponsoradx"+a]({zoneid:d,items:e.items,extralog:l},a)})};

cpmzone.prototype.changeBanhtml=function(a){
	var c=(document.location.pathname+"").replace(/'/g,"");var b="";"undefined"!=typeof a.scripttracking&&null!=a.scripttracking&&""!=a.scripttracking&&(b=a.scripttracking);if("undefined"!=typeof window.admerrorload&&window.admerrorload){try{var d="https://genmonet.com/ssp_request/video?u="+encodeURIComponent(document.domain+c)+"&z="+this.zid+"&p=1&w=650&h=300&"+admtvcPgid()+"&pid=&tags=5&adstype=&vtype=8&vid=&bannerid="+a.bid}catch(f){d="https://genmonet.com/ssp_request/video?u="+
encodeURIComponent(document.domain+c)+"&z="+this.zid+"&p=1&w=650&h=300&pid=&tags=5&adstype=&vtype=8&vid=&bannerid="+a.bid}a.src=a.src.replace("adi.admicro.vn",ADMStorageFileCDN.adi)}else try{d="https://"+ADMStorageFileCDN.ssp+"/ssp_request/video?u="+encodeURIComponent(document.domain+c)+"&z="+this.zid+"&p=1&w=650&h=300&"+admtvcPgid()+"&pid=&tags=5&adstype=&vtype=8&vid=&bannerid="+a.bid}catch(f){d="https://"+ADMStorageFileCDN.ssp+"/ssp_request/video?u="+encodeURIComponent(document.domain+c)+"&z="+this.zid+"&p=1&w=650&h=300&pid=&tags=5&adstype=&vtype=8&vid=&bannerid="+
a.bid}var e=980!=a.width||this.adn?a.width:1160,g=b+"<script>(function(){var doc=document;var wd={ban.width};var hg={ban.height};var url='{ban.src}?url='+encodeURIComponent(admGetUrlCk()+encodeURIComponent(__admLink));doc.write('<ifr'+'ame src=\"'+url+'&admid='+admid+'&vast='+encodeURIComponent('"+d+"')+'\" width=\"'+wd+'\" height=\"'+hg+'\" frameborder=\"0\" scrolling=\"no\"></ifr'+'ame>');/*reponsive*/})();\x3c/script>",h="<style>#_AdmExpand{position:relative !important;}</style><script>var vastUrl='"+
d+"';var admExpandCase=1;var admExpandPram={'src':'{ban.src_exp}','hs':90,'he':250,'wd':"+e+", 'btnClose': '//'+ADMStorageFileCDN.adi+'//adt/cpc/cpm7k/html/upload/2016/11/core/close.png'};\x3c/script><script src='//"+ADMStorageFileCDN.js+"/core/rickmedia-html5-core.js'>\x3c/script><script>(function(){var doc=document;var wd="+e+";var hg=90;var url='{ban.src}?url='+encodeURIComponent(admGetUrlCk()+encodeURIComponent(__admLink))+'&admid='+admid+'&vast='+encodeURIComponent('"+d+'\');doc.write(\'<iframe src="\'+url+\'" width="\'+ wd +\'" height="\'+hg+\'" frameborder="0" scrolling="no"></iframe>\');/*reponsive*/})();\x3c/script>';
c="var z = admid.split('_');var ads_zone = z[0]+'_'+z[1];var isDemo = parent.ADS_CHECKER.getQuery(\"demo\");var b=parent.document.getElementById(admid);b.style.width=\"100%\";var f=b.parentNode;console.log(f);var p = f.closest(\"div[id^=\"+ads_zone+\"]\");if(p.offsetWidth > 1160){f.style.width='1160px';}else{f.style.width='100%';}window.setTimeout(function(){var a=f.clientWidth,a=a>"+e+"?"+e+":a;a=Math.floor(("+e+'-(980>=a?980:a))/2);if(isDemo!="true"){document.body.style.position="relative";document.body.style.marginLeft="-"+(0>a?0:a)+"px"}},100);';
var k=b+"<script>var admZid=admid.split('_');var zoneId=admZid[1];var bannerId=admZid[3];var vastUrl='"+d+'\';var src=\'{ban.src}?url=\'+encodeURIComponent(admGetUrlCk()+encodeURIComponent(__admLink))+\'&admid=\'+admid+\'&vast=\'+encodeURIComponent(vastUrl);document.write(\'<iframe src="\'+src+\'" width="100%" height="100%" frameborder="0" scrolling="no"></iframe>\');\x3c/script><script src="https://'+ADMStorageFileCDN.adi+'/adt/cpc/tvcads/files/js/0520/delux_expandable.js">\x3c/script>';980!=a.width&&1160!=
a.width&&1040!=a.width||"undefined"==typeof a.src_exp||null==a.src_exp||""==a.src_exp?b=1160==a.width?(b+"<script>(function(){var isDemo = parent.ADS_CHECKER.getQuery(\"demo\");var b=parent.document.getElementById(admid);b.style.width=\"100%\";var f=b.parentNode;f.style.width='100%';window.setTimeout(function(){var a=f.clientWidth,a=a>1160?1160:a;a=Math.floor((1160-a)/2);if(isDemo!=\"true\"){document.body.style.position=\"relative\";document.body.style.marginLeft=\"-\"+(0>a?0:a)+\"px\"}},100);var doc=document;var wd={ban.width};var hg={ban.height};var url='{ban.src}?url='+encodeURIComponent(admGetUrlCk()+encodeURIComponent(__admLink));doc.write('<ifr'+'ame src=\"'+url+'&admid='+admid+'&vast='+encodeURIComponent('"+
d+"')+'\" width=\"'+wd+'\" height=\"'+hg+'\" frameborder=\"0\" scrolling=\"no\"></ifr'+'ame>');})();\x3c/script>").replace(/\{ban.width\}/gi,e).replace(/\{ban.height\}/gi,a.height).replace(/\{ban.src\}/gi,a.src):660==a.width?(b+'<script>(function(){var isDemo = parent.ADS_CHECKER.getQuery("demo");var b=parent.document.getElementById(admid);b.style.width="100%";b.style.maxWidth="660px";var f=b.parentNode;f.style.width=\'100%\';window.setTimeout(function(){var a=f.clientWidth,a=a>660?660:a;a=Math.floor((660-a)/2);if(isDemo!="true"){document.body.style.position="relative";document.body.style.marginLeft="-"+(0>a?0:a)+"px"}},100);var doc=document;var wd={ban.width};var hg={ban.height};var url=\'{ban.src}?url=\'+encodeURIComponent(admGetUrlCk()+encodeURIComponent(__admLink));doc.write(\'<ifr\'+\'ame src="\'+url+\'&admid=\'+admid+\'&vast=\'+encodeURIComponent(\''+
d+"')+'\" width=\"'+wd+'\" height=\"'+hg+'\" frameborder=\"0\" scrolling=\"no\"></ifr'+'ame>');})();\x3c/script>").replace(/\{ban.width\}/gi,e).replace(/\{ban.height\}/gi,a.height).replace(/\{ban.src\}/gi,a.src):1920==a.width?k.replace(/\{ban.width\}/gi,e).replace(/\{ban.height\}/gi,a.height).replace(/\{ban.src\}/gi,a.src):g.replace(/\{ban.width\}/gi,e).replace(/\{ban.height\}/gi,a.height).replace(/\{ban.src\}/gi,a.src):(a.height=90,this.addCss("#"+this.strkey+this.zid+" div,#"+this.strkey+this.zid+
" iframe{width:100% !important;}"),b=h.replace(/\{ban.src\}/gi,a.src).replace(/\{ban.src_exp\}/gi,a.src_exp));980<=a.width&&!this.adn?b=b.replace(/\/\*reponsive\*\//i,c):980<a.width&&(b=b.replace(/\/\*reponsive\*\//i,c));a.type="iframe";a.src=b;return a};
cpmzone.prototype.renderHookeye=function(a){window.__admCpmHeStick=!0;this.logSend.push(this.lg(a,!0,!1));"undefined"!=typeof a.link3rd&&""!=a.link3rd&&null!=a.link3rd&&this.link3rd.push(a.link3rd);document.getElementById(this.strkey+this.zid).innerHTML='<div id="cpmhezone_'+this.zid+'"></div>';var e=this.lg(a,!1,!1).replace(/&re=(.*)$/,"&re="),g='<a class="admLogoAdx'+this.zid+'" href="'+e+'" target="_blank">'+(this.adn?'<span class="txtlogo">Admicro AdX</span>':"")+"<span></span></a>";this.admt&&
(g='<a class="admLogoAdmatic'+this.zid+'" href="'+e+'" target="_blank">'+(this.adn?'<span class="txtlogo">Ads by Admatic</span>':"")+"<span></span></a>");var h=this.zid;document.getElementById("cpmhezone_"+this.zid).append(function(c){var d=document.createDocumentFragment(),k=document.createElement("div");for(k.innerHTML=c;k.firstChild;)d.appendChild(k.firstChild);return d}('<div id="cpmzonehookeye_'+this.zid+'" style="position:relative;width:'+a.width+'px;height:auto;text-align:center;background:url(https://'+ADMStorageFileCDN.adi+'/adt/cpc/cpm7k/html/upload/2018/12/background.png);border:1px solid rgb(202, 195, 195);"><a href="http://admicro.vn" target="_blank" style=""><div id="background_'+
this.zid+'" style="width: 100%;height: 100%;position: absolute;"></div></a><iframe id="hookeye_frame_'+this.zid+'" width="450" height="600" scrolling="no" frameborder="0" style="position:relative;"></iframe>'+g+"</div>"));window.setTimeout(function(){var c='<script>\nfunction admGetUrlCk(){\nreturn "'+e+'";\n}\nvar __admLink = "'+a.link+'";\nvar banWidth = '+a.width+';\nvar zoneid = "'+h+'";\nvar cpmZoomOut = false;\nvar checkResolution = function(){\ntry{\nvar b = parent.document.getElementById("hookeye_frame_'+
...
f=-1!=f.toLowerCase().indexOf("src=")?f:'<script type="text/javascript" src="'+f+'">\x3c/script>';g.appendChild(b);window.setTimeout(function(){var c=document.getElementById(b.id);c=c.contentWindow?c.contentWindow.document:c.contentDocument?c.contentDocument:c.document;c.write('<img src="https://'+ADMStorageFileCDN.adi+'/adt/cpc/tvcads/files/images/ban_150620/ias.png"/>'+f);c.close()},0)}};
...
a.opt.method),e=d.replace("_","")+this.zid,c=1920!=a.width||540!=a.height&&450!=a.height?c+('<iframe   src="javascript:if(typeof('+e+")!='undefined'){"+e+".renderIframe();}else{parent."+e+'.renderIframe();}" style="border:none;background:#fff;" marginheight="0" align="top" scrolling="No" frameborder="0" hspace="0" vspace="0" name="'+d+this.zid+"_"+b+"_"+a.bid+'" id="'+d+this.zid+"_"+b+"_"+a.bid+'" width="'+a.width+'" height="'+a.height+'" ></iframe>'):c+('<iframe sandbox="allow-scripts"  src="javascript:if(typeof('+e+")!='undefined'){"+
...
b&&(d=Math.floor((b-1160)/2));this.addCss("."+this.strkey+this.zid+"_img{margin-left:"+d+"px;}")},1E3));this.addCss("."+this.strkey+this.zid+"_img{max-width: unset !important;width:unset !important} #"+this.strkey+this.zid+" div{width:"+b+"px  !important;overflow:hidden;}");a.width=1160}else"100%"==a.width&&this.addCss("."+this.strkey+this.zid+"_img{max-width: unset !important;width:100% !important}");c='<img class="'+this.strkey+this.zid+'_img" border="0" id="cpm'+this.zid+'" src="'+a.src+'"'+(a.width?
' width="'+a.width+'"':"")+(a.height?' height="'+a.height+'"':"");c+="  />";return a.link?'<a style="width:100%; max-width:'+a.width+'px;display:flex;justify-content: center;overflow:hidden;" rel="nofollow" href="'+this.lg(a,!1,!1)+'" target="_blank">'+c+"</a>":c};
...
cpmzone.prototype.checkSend=function(){try{var d="cpmzone";this.adn&&(d="adnzone");if("stick"==this.type){for(var b=this.logSend,f=this,a=0,g=b.length;a<g;a++){var h=b[a];(function(c){window.setTimeout(function(){f.renderLinkViews(c)},2500)})(h)}return!1}var k=ADS_CHECKER.getElementTop(d+"_"+this.zid),p=document.getElementById(d+"_"+this.zid).clientHeight,q=ADS_CHECKER.getScrollTop()+ADS_CHECKER.wdHeight(),l=!1,m=!1;"undefined"!=typeof this.balloon&&1==this.balloon&&(l=!0);try{"undefined"!=typeof this.data&&
"undefined"!=typeof this.data.cpd&&!0===this.data.cpd&&(m=!0)}catch(c){}if(!this.chksend&&(l||m||0<p&&(k+250<=q||10>=k))){f=this;this.chksend=!0;b=this.logSend;a=0;for(g=b.length;a<g;a++)this.adn?this.renderLinkViews(b[a]):(h=b[a],function(c){window.setTimeout(function(){f.renderLinkViews(c)},2500)}(h));if(0<this.link3rd.length)for(a=0;a<this.link3rd.length;a++){var n=this.link3rd[a].split("|:^|");for(b=0;b<n.length;b++)__admTracki3Rd(n[b].replace("[timestamp]",Math.floor(1E6*Math.random())).replace("{timestamp}",
Math.floor(1E6*Math.random())).replace("$$[admicro_uid]$$",ADM_AdsTracking.get("__uid")||""))}if(this.rotate){this.rotateFinish=!1;this.rotateIndex=1;var e=d+this.zid;window[e].runRotate=0;window[e+"_timeout"]&&clearTimeout(window[e+"_timeout"]);window[e+"_timeout"]=window.setTimeout(function(){window[e].renderRotate()},1E4)}return!1}setTimeout(d+this.zid+".checkSend()",100)}catch(c){console.log(c.message)}};
...
(function () {
	if((typeof(_admchildHeight)=='undefined' || _admchildHeight===undefined)){
		window.setTimeout(function(){
			...
			a.async = !0;
			var mb = ADS_CHECKER.isMobile.iOS() || ADS_CHECKER.isMobile.Android() ? '/core/mbtk.js' : '/tf/tftk.js?id=1'
			a.src = "https://"+ADMStorageFileCDN.js+mb;
...
_admloadJs('//'+ADMStorageFileCDN.js+'/tf/admcoreext.js');
...
(function(){
	var ele=document.querySelector('[src*="/tf/common.min.js"]');
    if(!ele && typeof (agencyArf)=='undefined'){
        _admloadJs('https://'+ADMStorageFileCDN.js+'/tf/common.min.js');
    }
})();
...
admicroAD.drawad=function(str){
	...
	if(!ADS_CHECKER.in_array(id,admicroAD.loaded )){
		if(typeof(ADMStorageFileCDN)!='undefined'){
			...
			_admloadJs('//'+ADMStorageFileCDN.js+'/cms/arf-'+id+'.min.js',function(){},function(){

				window.chkAdmblockAds=window.chkAdmblockAds||false;
				if(!window.chkAdmblockAds){
					window.chkAdmblockAds=true;
					_admloadJs('https://'+ADMStorageFileCDN.js+'/cms/Arfcc.min.js',function(){
						_admloadJs('https://'+ADMStorageFileCDN.js+'/cms/arf-'+id+'.min.js');
					})
...
w:b.w,h:b.h,callback:"undefined"!=typeof e.backFieldSrc?e.backFieldSrc:null}}catch(l){}"undefined"!=typeof e.company&&"admicro"!=e.company?admsspRegister.writeIframe(c,{w:b.w,h:b.h}):admsspRegister.writeIframe(c)}catch(l){AdmLoadDefault("sspbid_"+c)}}else 4==d.readyState&&400!=d.status&&(m?-1==(document.domain+"").indexOf("kenh14.vn")&&AdmLoadDefault("sspbid_"+c):(m||(m=!0,d.open("GET","//defaultdsp.contineljs.com/dsp_default?"+("w="+b.w+"&isdetail="+("undefined"!=typeof b.isdetail?b.isdetail:"")+"&h="+
b.h+"&z="+c+__AdmsendRandom),!0),d.setRequestHeader("Content-type","application/x-www-form-urlencoded"),d.send()),a()))};d.send()})()})()}
